...
//        EditText editText = (EditText)searchView.findViewById(R.id.search);
//        editText.setTextColor(Color.BLACK);
//        int id = searchView.getContext().getResources().getIdentifier("android:id/searchView",
//                            null,null);

//        searchView textView=(TextView)searchView.findViewById(id);
...
//        if(currentColor.equalsIgnoreCase("")){
//            getListView().setBackgroundColor(Color.parseColor("#f5f5f5"));
//        }else{
//            getListView().setBackgroundColor(Color.parseColor(currentColor));
//        }
